...
function initAudio(){
    //load audio files
    beepX = new Audio('media/sounds/beepX.mp3');
    beepY = new Audio('media/sounds/beepY.mp3');
    beepPaddle = new Audio('media/sounds/beepPaddle.mp3');
    beepGameOver = new Audio('media/sounds/beepGameOver.mp3');
    bgMusic = new Audio('media/sounds/music.mp3');
    //turn off volume
    beepX.volume = 0;
    beepY.volume = 0;
    beepPaddle.volume = 0;
    ...
    // let soundFiles = ["beepGameOver","beepPaddle","beepX","beepY","music"]
    // for(let i = 0; i < 5; i++){
    //     soundFiles[i] = new Audio('media/sounds/'+i+'.mp3');
    //     soundFiles[i].volume = 0;
    //     soundFiles[i].play();
    //     soundFiles[i].pause();
    //     soundFiles[i].volume = 1;
    // }
}
